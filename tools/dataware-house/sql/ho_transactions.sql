IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES 
           WHERE TABLE_NAME = N'ho_transactions')
BEGIN
  ...
  SELECT * INTO __ho_transactions FROM ho_transactions

END
GO

CREATE NONCLUSTERED INDEX date_index ON ho_transactions  (ipg_date);
CREATE NONCLUSTERED INDEX year_index ON ho_transactions  (ipg_year);
CREATE NONCLUSTERED INDEX month_index ON ho_transactions  (ipg_month);
CREATE NONCLUSTERED INDEX week_index ON ho_transactions  (ipg_week);
CREATE NONCLUSTERED INDEX year_week_index ON ho_transactions  (ipg_year_week);
CREATE NONCLUSTERED INDEX year_month_index ON ho_transactions  (ipg_year_month);
CREATE NONCLUSTERED INDEX cc_index ON ho_transactions  (ipg_cc);
CREATE NONCLUSTERED INDEX product_index ON ho_transactions  (ipg_product);
CREATE NONCLUSTERED INDEX level0Category_index ON ho_transactions  (ipg_level0Category);
CREATE NONCLUSTERED INDEX merchant_index ON ho_transactions  (ipg_merchantName);
CREATE NONCLUSTERED INDEX device_index ON ho_transactions  (ipg_device);
CREATE NONCLUSTERED INDEX dealType_index ON ho_transactions  (ipg_dealType);
GO
